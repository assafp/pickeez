def send_push_notif(device_tokens_arr,alert,info)
  ...
  res = HTTPClient.new.post(route, {auth_token:token, "device_tokens[]" => device_tokens_arr, info: info.to_json, alert: alert})
